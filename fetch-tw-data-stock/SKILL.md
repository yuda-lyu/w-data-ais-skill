    ...
    "tables": [
      {
        ...
        "data": [
          ["2330", "台積電", "28,456,789", "18,567", "28,456,789,012", "982.00", "990.00", "980.00", "988.00", "+", "6.00", "..."]
        ]
      }
    ]
  }
...
> 全市場 MI_INDEX 回傳多個 `tables`（實測約 10 個）；腳本原樣回傳，下游以 title 含「每日收盤行情」定位個股 OHLC 表、並以 `fields` **欄名**（非固定索引）取值。早期 `data9`/`fields9` 形式已不再使用。
