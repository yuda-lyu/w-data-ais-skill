...
1. **執行腳本**：`node fetch-tpex/scripts/fetch_tpex.mjs [stockCode|all] [date] [outputPath]`
...
# 範例：逗號分隔多檔查詢
node fetch-tpex/scripts/fetch_tpex.mjs 6499,4977 20260210 ./data/tpex_multi.json
```
