// fetchAiNewsAggregator.mjs — 取得 AI News Aggregator 新聞並轉換為統一格式
//
// 本檔為 w-dwdata-hub 套件之轉發層：實作已抽出至該套件統一維護，
// 此處僅保留技能既有的匯入路徑與函式名稱，故既有呼叫端無須改動。
//
// fetchAiNewsAggregator(opt) → [{ url, time, title, description, from }]
...
export const fetchAiNewsAggregator = hub.fetchAiNewsAggregator;
