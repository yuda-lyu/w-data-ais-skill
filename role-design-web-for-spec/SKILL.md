...
> 簡報引擎為純 HTML + JS，不依賴框架 —— 見 [references/patterns-advanced.md](references/patterns-advanced.md)（響應式簡報引擎章節）。
...
> 完整範例（ECharts 初始化、tooltip、dark mode 切換、ResizeObserver）見 [references/patterns-advanced.md](references/patterns-advanced.md)（資料視覺化樣板章節）
